...
SYS_STUB(9, int, link,
    ...
    /* _callargs */ ((__cheri_cast const char *)path, (__cheri_cast const char *)to),
...
SYS_STUB(14, int, mknod,
    ...
    /* _callargs */ ((__cheri_cast const char *)path, mode, dev),
...
SYS_STUB(21, int, mount,
    ...
    /* _callargs */ ((__cheri_cast const char *)type, (__cheri_cast const char *)path, flags, (__cheri_cast void *)data),
...
SYS_STUB(29, ssize_t, recvfrom,
    ...
    /* _callargs */ (s, (__cheri_cast void *)buf, len, flags, (__cheri_cast struct sockaddr *__restrict)from, (__cheri_cast socklen_t *__restrict)fromlenaddr),
...
SYS_STUB(30, int, accept,
    ...
    /* _callargs */ (s, (__cheri_cast struct sockaddr *__restrict)name, (__cheri_cast socklen_t *)anamelen),
...
SYS_STUB(31, int, getpeername,
    ...
    /* _callargs */ (fdes, (__cheri_cast struct sockaddr *__restrict)asa, (__cheri_cast socklen_t *)alen),
...
SYS_STUB(59, int, execve,
    ...
    /* _callargs */ ((__cheri_cast const char *)fname, (__cheri_cast struct chericap *)argv, (__cheri_cast struct chericap *)envv),
...
SYS_STUB(118, int, getsockopt,
    ...
    /* _callargs */ (s, level, name, (__cheri_cast void *)val, (__cheri_cast socklen_t *)avalsize),
...
SYS_STUB(148, int, quotactl,
    ...
    /* _callargs */ ((__cheri_cast const char *)path, cmd, uid, (__cheri_cast void *)arg),
...
SYS_STUB(154, int, nlm_syscall,
    ...
    /* _callargs */ (debug_level, grace_period, addr_count, (__cheri_cast struct chericap *)addrs),
...
SYS_STUB(155, int, nfssvc,
    ...
    /* _callargs */ (flag, (__cheri_cast void *)argp),
...
SYS_STUB(188, int, stat,
    ...
    /* _callargs */ ((__cheri_cast const char *)path, (__cheri_cast struct stat *)ub),
...
SYS_STUB(196, int, getdirentries,
    ...
    /* _callargs */ (fd, (__cheri_cast char *)buf, count, (__cheri_cast long *)basep),
...
SYS_STUB(272, int, getdents,
    ...
    /* _callargs */ (fd, (__cheri_cast char *)buf, count),
...
SYS_STUB(278, int, nstat,
    ...
    /* _callargs */ ((__cheri_cast const char *)path, (__cheri_cast struct nstat *)ub),
    /* _callargs_chk */ (&ret, stub_errno, path, ub),
...
SYS_STUB(279, int, nfstat,
    ...
    /* _callargs */ (fd, (__cheri_cast struct nstat *)sb),
    /* _callargs_chk */ (&ret, stub_errno, fd, sb),
...
SYS_STUB(390, int, kenv,
    ...
    /* _callargs */ (what, (__cheri_cast const char *)name, (__cheri_cast char *)value, len),
...
SYS_STUB(394, int, mac_syscall,
    ...
    /* _callargs */ ((__cheri_cast const char *)policy, call, (__cheri_cast void *)arg),
...
SYS_STUB_ARGHASPTRS(415, int, __mac_execve,
    ...
    /* _callargs */ ((__cheri_cast char *)fname, (__cheri_cast struct chericap *)argv, (__cheri_cast struct chericap *)envv, (__cheri_cast struct mac*)mac_p),
...
SYS_STUB(446, int, auditon,
    ...
    /* _callargs */ (cmd, (__cheri_cast void *)data, length),
...
SYS_STUB(492, int, fexecve,
    ...
    /* _callargs */ (fd, (__cheri_cast struct chericap *)argv, (__cheri_cast struct chericap *)envv),
...
SYS_STUB(495, int, linkat,
    ...
    /* _callargs */ (fd1, (__cheri_cast const char *)path1, fd2, (__cheri_cast const char *)path2, flag),
...
SYS_STUB_VA(499, int, openat, flag,
    ...
    /* _callargs */ (fd, (__cheri_cast const char *)path, flag, mode),
...
SYS_STUB(503, int, unlinkat,
    ...
    /* _callargs */ (fd, (__cheri_cast const char *)path, flag),
...
SYS_STUB(541, int, accept4,
    ...
    /* _callargs */ (s, (__cheri_cast struct sockaddr *__restrict)name, (__cheri_cast socklen_t *__restrict)anamelen, flags),
